...
public enum SerializedNode: Equatable, Sendable {
  case artificial(SerializedArtificialNode)
  ...
  public init(json: JSONValue) {
    ...
    case "artificial": self.init(json, as: Self.artificial)
  ...
  public var json: JSONValue {
    switch self {
    case .artificial(let node): node.json
...
public struct SerializedArtificialNode: ElementNodePayload {
  public static let type = "artificial"
  ...
  public init(json: JSONValue) throws {
    ...
    direction = fields.take("direction", Schema.direction)
  ...
  public var json: JSONValue {
    ...
    fields.put("direction", direction, Schema.direction)
...
public struct SerializedAutolinkNode: ElementNodePayload {
  ...
  public init(json: JSONValue) throws {
    ...
    rel = fields.take("rel", Schema.rel)
    target = fields.take("target", Schema.target)
    textFormat = fields.take("textFormat", Schema.textFormat)
    textStyle = fields.take("textStyle", Schema.textStyle)
  ...
  public var json: JSONValue {
    ...
    fields.put("rel", rel, Schema.rel)
    fields.put("target", target, Schema.target)
    fields.put("textFormat", textFormat, Schema.textFormat)
    fields.put("textStyle", textStyle, Schema.textStyle)
...
public struct SerializedCodeHighlightNode: NodePayload {
  ...
  public init(json: JSONValue) throws {
    ...
    format = fields.take("format", Schema.format)
    highlightType = fields.take("highlightType", Schema.highlightType)
  ...
  public var json: JSONValue {
    ...
    fields.put("format", format, Schema.format)
    fields.put("highlightType", highlightType, Schema.highlightType)
