...
type ToastProps = React.ComponentPropsWithRef<typeof ToastPrimitives.Root> &
...
type ToastCloseProps = React.ComponentPropsWithRef<
...
type ToastTitleProps = React.ComponentPropsWithRef<
