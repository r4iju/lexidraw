...
export const hsvaToRgba = ({ h, s, v, a }: HsvaColor): RgbaColor => {
  ...
  return {
    r: round(([v, c_val, b_val, b_val, d_val, v][hueSegment] as number) * 255),
    g: round(([d_val, v, v, c_val, b_val, b_val][hueSegment] as number) * 255),
    b: round(([b_val, b_val, d_val, v, v, c_val][hueSegment] as number) * 255),
    a: round(a, 2),
  };
};
